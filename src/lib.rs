...
//! randomness.
//! * `Limit`: The upper limit for the size of dynamic data structures generated by the implementor
//! of `DieOnce` or `Die`. The implementor is allowed to freely interpret or even ignore this value.
//!
//! ```
//! use dicetest::prelude::*;
